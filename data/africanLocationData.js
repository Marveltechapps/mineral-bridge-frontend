/**
 * African countries and states/districts for Artisanal Location screen.
 * States use same country codes as lib/countries.js. Districts are keyed by country code and state name.
 */
import { COUNTRIES } from '../lib/countries';
import { getStatesForCountry } from '../lib/countriesStates';

const AFRICAN_COUNTRY_CODES = new Set([
  'DZ', 'AO', 'BJ', 'BW', 'BF', 'BI', 'CV', 'CM', 'CF', 'TD', 'KM', 'CG', 'CD', 'DJ', 'EG', 'GQ', 'ER', 'SZ', 'ET',
  'GA', 'GM', 'GH', 'GN', 'GW', 'CI', 'KE', 'LS', 'LR', 'LY', 'MG', 'MW', 'ML', 'MR', 'MU', 'MA', 'MZ', 'NA', 'NE',
  'NG', 'RW', 'ST', 'SN', 'SC', 'SL', 'SO', 'ZA', 'SS', 'SD', 'TZ', 'TG', 'TN', 'UG', 'ZM', 'ZW',
]);

/** African countries sorted by name, each { code, name }. */
export function getAfricanCountries() {
  return COUNTRIES
    .filter((c) => AFRICAN_COUNTRY_CODES.has(c.code))
    .sort((a, b) => a.name.localeCompare(b.name));
}

/** States/regions for an African country (by country code). Uses lib/countriesStates where available. */
export function getStatesForAfricanCountry(countryCode) {
  return getStatesForCountry(countryCode) || [];
}

/**
 * Districts by country code and state name.
 * Keys: countryCode -> { stateName -> string[] }
 */
const DISTRICTS_BY_COUNTRY_STATE = {
AO: {
    'Bengo': [
        'Ambriz',
        'Bula Atumba',
  ...
  BF: {
    ...
    'Plateau-Central': [
        'Province du Bassitenga',
        'Province du Ganzourgou',
        'Province du Kourwéogo'
      ],
    'Sahel': [
        'Oudalan',
        'Province du Djelgodji',
        'Province du Séno',
        'Province du Yagha'
      ],
    'Sud-Ouest': [
  ...
  BJ: {
    ...
    'Atlantique': [
        ...
        'Commune of So-Ava',
        'Commune of Toffo',
        'Commune of Tori-Bossito',
        'Commune of Ze'
      ],
    'Borgou': [
        'Bembereke',
        'Commune of Parakou',
        'Commune of Tchaourou',
        'Kalalè',
        'Ndali',
        'Nikki',
        'Pèrèrè',
  ...
  DZ: {
    ...
    'Tiaret': [
        ...
        'Dahmouni',
        'Daïra de Frenda',
        'Daïra de Tiaret daira de meghila',
        'Hamadia',
        'Ksar Chellala',
        'Mahdia',
        'Mechraa Sfa',
  ...
  EG: {
    ...
    'Beheira': [
        'Markaz Abū al Maţāmīr',
        'Markaz Abū Ḩummuş',
        'Markaz ad Dilinjāt',
        'Markaz al Maḩmūdīyah',
        'Markaz ar Raḩmānīyah',
        'Markaz Damanhūr',
        'Markaz Ḩawsh ‘Īsá',
        'Markaz Idkū',
        'Markaz Ītāy al Bārūd',
    ...
    'Beni Suweif': [
        ...
        'Markaz Bibā',
        'Markaz Būsh',
        'Markaz Ihnāsiyā al Madīnah',
        'Markaz Nāşir',
        'Markaz Sumusţā al Waqf'
      ],
    'Cairo': [
        'Al Marj',
        'Markaz al Khānkah',
    ...
    'Ismailia': [
        'Markaz al Ismā‘īlīyah',
        'Markaz al Qanţarah Gharb',
        'Markaz al Qanţarah Sharq',
        'Markaz Fāyid'
      ],
    'Kafr el-Sheikh': [
        'Kafr El Sheikh',
    ...
    'Monufia': [
        ...
        'Markaz ash Shuhadā’',
        'Markaz Ashmūn',
        'Markaz Birkat as Sab‘',
        'Markaz Quwaysinā'
      ],
    'New Valley': [
        'Baris Shurtah',
        'Markaz al Wāḩāt ad Dākhilah',
        'Markaz al Wāḩāt al Khārijah',
        'Shurtah al-Farafirah'
      ],
    'North Sinai': [
        'Markaz al ‘Arīsh',
        'Markaz ash Shaykh Zuwayd',
        'Markaz Bi’r al ‘Abd',
        'Markaz Rafaḩ'
      ],
    'Port Said': [
    ...
    'Sharqia': [
        ...
        'Markaz Abū Ḩammād',
        'Markaz Abū Kabīr',
        'Markaz al Ḩusaynīyah',
        'Markaz at Tall al Kabīr',
        'Markaz az Zaqāzīq',
        'Markaz Bilbays',
        'Markaz Diyarb Najm',
        'Markaz Hihyā',
        'Markaz Minyā al Qamḩ'
      ],
    'Sohag': [
        'Markaz Akhmīm',
        'Markaz al Balyanā',
        'Markaz al Marāghah',
        'Markaz al Munsha’ah',
        'Markaz Awlād Ţawq Sharq',
        'Markaz Dār as Salām',
        'Markaz Jirjā',
        'Markaz Juhaynah al Gharbīyah',
        'Markaz Sūhāj'
      ],
    'South Sinai': [
        'Markaz Aţfīḩ'
  ...
  GA: {
    ...
    'Moyen-Ogooué': [
        'Abanga-Bigné Department',
        'Ogooue et des Lacs'
      ],
    'Ngouni': [
        'Boumi-Louetsi',
        'Dola Department',
        'Douya-Onoye Department',
        'Louetsi-Bibaka',
  ...
  LR: {
    ...
    'Montserrado County': [
        ...
        'Kakata',
        'Mambah-Kaba',
        'Saint Paul River District',
        'St. Paul River',
        'Todee',
        'Topee'
      ],
    'Nimba': [
        'Boe and Quilla District',
        'Buu-Yao District',
        'Doe',
        'Garr-Bain District',
        'Gbehlay-Geh',
    ...
    'Sinoe County': [
        ...
        'Pynes Town District',
        'Pyneston District',
        'Sanquin District Number One',
        'Sanquin District Number Three',
        'Sanquin District Number Two',
        'Seedor',
        'Seekon',
        'Tarjuazon',
        'Tasu',
  ...
  MZ: {
    'Cabo Delgado Province': [
        ...
        'Chiure',
        'Cidade de Pemba',
        'Circunscrição da Quissanga',
        'Circunscrição de Macomia',
        'Circunscrição de Palma',
        'Concelho do Ibo',
        'Mecufi',
        'Meluco',
        'Metuge District',
    ...
    'Nampula': [
        'Angoche District',
        'Cidade de Nampula',
        'Circunscrìção de Mogovolas',
        'Circunscrição de Murrupula',
        'Circunscrição do Eráti',
        'Circunscrìção do Mogincual',
        'Concelho de Monapo',
        'Distrito de Larde',
        'Distrito de Liúpo',
        'Distrito de Moma',
    ...
    'Niassa Province': [
        'Cidade de Lichinga',
        'Circunscrição de Mandimba',
        'Circunscrição de Sanga',
        'Cuamba',
        'Lago District',
        'Lichinga District',
        'Majune District',
    ...
    'Tete': [
        ...
        'Chiuta District',
        'Cidade de Tete',
        'Circunscrição da Macanga',
        'Circunscrição da Mutarara',
        'Circunscrição de Màgoé',
        'Circunscrição de Marávia',
        'Distrito de Dôa',
        'Distrito de Marara',
        'Luenha',
        'Moatize',
  ...
  NG: {
    ...
    'Kebbi': [
        ...
        'Kalgo',
        'Koko-Besse',
        'Koko/Besse Local Government Area',
        'Maiyama',
        'Ngaski',
        'Sakaba',
        'Shanga',
  ...
  SD: {
    'Al Jazirah': [
        'El Meilig Rural Council',
        'Mudīrīyat al Jazīrah',
        'Um Al Gura'
      ],
    'Al Qaḑārif': [
        'Al Fushqa',
        'Gedaref North Rural Council',
        'Seteet'
      ],
    'Blue Nile': [
        'Baw'
    ...
    'North Kordofan': [
        ...
        'En Nuhud',
        'Ghebeish',
        'Mudīrīyat Kurdufān ash Shamālīyah',
        'Sheikan',
        'Um Rawaba'
      ],
    'Northern Darfur': [
        'Kutum District',
        'Mudīrīyat Dārfūr ash Shamālīyah'
      ],
    'Northern State': [
        'Al Mudīrīyah ash Shamālīyah',
        'Merawi'
      ],
    'Red Sea': [
        'Port Sudan',
  ...
  SN: {
    ...
    'Kolda': [
        'Département de Médina-Yorofoula',
        'Kolda Department',
  ...
  SS: {
    ...
    'Eastern Equatoria': [
        'Al Mudīrīyah al Istiwā’īyah ash Sharqīyah',
        'Budi',
        'Ikotos',
        'Lafon County',
        'Magwi County',
    ...
    'Northern Bahr al Ghazal': [
        'Aweil East',
        'Mudīrīyat Baḩr al Ghazāl ash Sharqīyah'
      ],
    'Unity': [
        'Guit County',
        'Rubkona'
  ...
  TN: {
    ...
    'Ben Arous Governorate': [
        ...
        'Délégation de la Nouvelle Médina',
        'Délégation de Mégrine',
        'Délégation de Radès',
        'El Mourouj',
        'Ezzahra',
        'Fouchana',
    ...
    'Bizerte Governorate': [
        ...
        'Mateur',
        'Menzel Jemil',
        'Mu‘tamadīyat Manzil Bū Ruqaybah',
        'Mu‘tamadīyat Ra’s al Jabal',
        'Sejnane',
        'Tinja',
        'Utique',
        'Zarzouna'
    ...
    'Gabès Governorate': [
        ...
        'Délégation de Gabès Sud',
        'Délégation de Gabès Ville',
        'El Hamma',
        'Ghannouch',
        'Mareth',
        'Matmata',
    ...
    'Medenine Governorate': [
        'Ben Guerdane',
        'Beni Khedeche',
        'Délégation de Médenine Sud',
        'Jerba Ajim',
        'Jerba Midoun',
        'Medenine Nord',
        'Mu‘tamadīyat Ḩawmat as Sūq',
        'Sidi Makhlouf',
        'Zarzis'
      ],
    ...
    'Tunis Governorate': [
        ...
        'Bab Souika',
        'Carthage',
        'Délégation de Cité El Khadra',
        'Délégation de la Médina',
...
/** Generic district options when no specific data exists for a state (so district dropdown always has options). */
const FALLBACK_DISTRICTS = ['Central', 'Northern', 'Southern', 'Eastern', 'Western', 'Urban', 'Rural'];

/** Get districts for a country code and state name. Returns districts from data or fallback list so dropdown is never empty. */
export function getDistrictsForState(countryCode, stateName) {
  if (!countryCode || !stateName) return [];
  const upper = String(countryCode).toUpperCase();
  const byState = DISTRICTS_BY_COUNTRY_STATE[upper];
  if (byState && byState[stateName] && byState[stateName].length > 0) return byState[stateName];
