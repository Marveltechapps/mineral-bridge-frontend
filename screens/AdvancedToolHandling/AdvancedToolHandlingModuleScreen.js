...
const LESSONS = [
  { id: '1', title: 'TOOL INVENTORY & INSPECTION', completed: true },
  { id: '2', title: 'POWER TOOL SAFETY', completed: true },
  { id: '3', title: 'HANDLING & STORAGE PROTOCOLS', completed: false },
  { id: '4', title: 'ADVANCED TOOL QUIZ', completed: false },
];

export default function AdvancedToolHandlingModuleScreen({ navigation }) {
    ...
    <View style={styles.wrapper}>
      <View style={styles.header}>
        <View style={styles.headerRow}>
          ...
          <View style={styles.headerTitleBlock}>
            <Text style={styles.headerTitle}>ADVANCED TOOL HANDLING</Text>
            <Text style={styles.headerSubtitle}>ASM TRAINING MODULE</Text>
          </View>
      ...
      <ScrollView style={styles.scroll} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <Text style={styles.summaryText}>
          Advanced protocols for tool selection, maintenance, and safe handling in artisanal mining operations.
        </Text>

        <View style={styles.infoRow}>
          <View style={styles.infoCard}>
            <Text style={styles.infoLabel}>DURATION</Text>
            <Text style={[styles.infoValue, { color: ACCENT_BLUE }]}>18 Mins</Text>
          </View>
          <View style={styles.infoCard}>
            <Text style={styles.infoLabel}>XP REWARD</Text>
            <Text style={[styles.infoValue, { color: ACCENT_BLUE }]}>+20 XP</Text>
          </View>
        </View>
        ...
        >
          <Text style={styles.completeBtnText}>MARK MODULE AS COMPLETE</Text>
        </Pressable>
      </ScrollView>
    </View>
  );
